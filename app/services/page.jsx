...
// Removed 'next/link' and replaced usages with standard 'a' tags to fix the compilation error.

// --- Icon Components (Replacing Lucide/SVG directly) ---
        ...
        <div className="min-h-screen text-gray-800 ">
            ...
            <section className="py-20 text-center shadow-lg">
                <div className="max-w-4xl mx-auto px-4">
                    <h1 className="text-5xl sm:text-6xl font-extrabold leading-tight dark:text-white mt-10">
                        Simplify Your Money, Smarter Decisions
                    </h1>
                    <p className="mt-4 text-xl text-gray-600 max-w-2xl mx-auto dark:text-gray-200">
                        Discover how FiriApp turns complex finance tracking into an intuitive, real-time experience. Our services are built to put you in control.
                    </p>
                    <a href="/sign-up" className="mt-8 inline-block px-8 py-3 bg-primary-accent  font-semibold rounded-xl shadow-lg hover:bg-opacity-90 transition duration-300 transform hover:scale-[1.02] dark:text-white shadow-white">
