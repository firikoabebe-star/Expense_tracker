...
function CardInfo({budgetList}: CardInfoProps) {
  ...
  return (
    ...
    <div className='mt-7 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5'> 
      ...
      <div className='p-7 border dark:border-[#585b5a] rounded-lg flex items-center justify-between'>
        <div>
      ...
      <div className='p-7 border rounded-lg flex items-center justify-between dark:border-[#585b5a]'>
        <div>
